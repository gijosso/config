...
" 
" Edited by Thomas Josso
" C and C++ syntax edition with Polyglot
"
" Initialization {{{
...
let s:comment_blue = s:colors.comment_blue
let s:comment_light = s:colors.comment_light
let s:gutter_fg_grey = s:colors.gutter_fg_grey
let s:cursor_grey = s:colors.cursor_grey
let s:visual_grey = s:colors.visual_grey
let s:visual_lightgrey = s:colors.visual_lightgrey
...
call s:h("Search", { "fg": s:black, "bg": s:dark_yellow }) " Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
...
call s:h("Visual", { "fg": s:visual_black, "bg": s:visual_lightgrey }) " Visual mode selection
...
" C
call s:h("cConstant", { "fg": s:cyan }) " any constant
call s:h("cString", { "fg": s:green }) " a string constant: "this is a string"
call s:h("cCharacter", { "fg": s:green }) " a character constant: 'c', '\n'
call s:h("cNumber", { "fg": s:dark_yellow }) " a number constant: 234, 0xff
call s:h("cBoolean", { "fg": s:dark_yellow }) " a boolean constant: TRUE, false
call s:h("cFloat", { "fg": s:dark_yellow }) " a floating point constant: 2.3e10
call s:h("cIdentifier", { "fg": s:red }) " any variable name
call s:h("cFunction", { "fg": s:blue }) " function name (also: methods for classes)
call s:h("cStatement", { "fg": s:purple }) " any statement
call s:h("cLabel", { "fg": s:purple }) " case, default, etc.
call s:h("cConditional", { "fg": s:purple }) " if, then, else, endif, switch, etc.
call s:h("cRepeat", { "fg": s:purple }) " for, do, while, etc.
call s:h("cOperator", { "fg": s:cyan })
call s:h("cPreProc", { "fg": s:yellow }) " generic Preprocessor
call s:h("cInclude", { "fg": s:blue }) " preprocessor #include
call s:h("cDefine", { "fg": s:yellow }) " preprocessor #define
call s:h("cPreCondit", { "fg": s:yellow }) " preprocessor #if, #else, #endif, etc.
call s:h("cStorageClass", { "fg": s:purple }) " static, register, volatile, etc.
call s:h("cType", { "fg": s:purple }) " int, long, char, etc.
call s:h("cStructure", { "fg": s:yellow }) " struct, union, enum, etc.
call s:h("cTypedef", { "fg": s:yellow }) " A typedef
call s:h("cSpecial", { "fg": s:purple }) " any special symbol
call s:h("cSpecialChar", { "fg": s:purple }) " special character in a constant
call s:h("cTag", {}) " you can use CTRL-] on this
call s:h("cDelimiter", { "fg": s:white }) " character that needs attention
call s:h("cBraces", { "fg": s:comment_grey }) " {}
call s:h("cParenthesis", { "fg": s:comment_grey }) " {}
call s:h("cSemiColon", { "fg": s:comment_grey }) " character that needs attention
call s:h("cColon", { "fg": s:comment_grey }) " character that needs attention
call s:h("cComment", { "fg": s:comment_light }) " special things inside a comment
call s:h("cSpecialComment", { "fg": s:comment_grey }) " special things inside a comment
call s:h("cDebug", {}) " debugging statements
call s:h("cUnderlined", { "gui": "underline", "cterm": "underline" }) " text that stands out, HTML links
call s:h("cIgnore", {}) " left blank, hidden
call s:h("cError", { "fg": s:red }) " any erroneous construct
call s:h("cTodo", { "fg": s:dark_yellow }) " anything that needs extra attention; mostly the keywords TODO FIXME and XXX
