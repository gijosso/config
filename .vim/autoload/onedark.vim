...
let s:colors = {
      ...
      \ "comment_blue": get(s:overrides, "comment_blue", { "gui": "#7584a8", "cterm": "24", "cterm16": "4" }),
      \ "comment_light": get(s:overrides, "comment_light", { "gui": "#D19A66", "cterm": "243", "cterm16": "11" }),
      ...
      \ "visual_lightgrey": get(s:overrides, "visual_lightgrey", { "gui": "#3E4452", "cterm": "240", "cterm16": "15" }),
